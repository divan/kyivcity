...
18. Конкурсний відбір проводиться у два етапи:
	...
	2. Розподіл коштів бюджету міста Києва, передбачених для надання фінансової підтримки громадським організаціям, за такими категоріми:
   - спортивні заходи міського та всеукраїнського рівня - 30%;
   - навчально-тренувальні збори - 20%;
   - спортивно-масові заходи клубів - 50%. 
...
Рейтинг конкурсних пропозицій складається з суми наступних критеріїв:
 ...
 - до 10% - масовість заходів проведених організацією за попередній рік;
 - до 10% - відсоток софінансування заходів конкурсної пропозиції;
 - до 10% - кількість спортсменів-киян, які взяли участь у спортивних заходах всеукраїнського рівня; 
 - до 10% - кількість спортсменів-киян, які які посіли призові місця, у спортивних заходах міського рівня;
 - до 10% - кількість спортсменів-киян, які посіли призові місця, у спортивних заходах міського рівня;
 - до 10% - наявний позитивний досвід проведення заходів;
 - до 10% - дотримання гендерного балансу в роботі організації, або запланованого спортивно-масового заходу;
 - до 10% - активність громадської організації в соціальних мережах;
 - до 10% - наявність річної звітності роботи організації в публічному доступі;
 - до 10% - інклюзивний підхід в роботі організації, або проведенні запланованого спортивно-масового заходу.
 
 Конкурсна комісія оцінює кожну конкурсну пропозицію за кожним з 10-ти критеріїв і виставляє відвовідний бал за принципом: низький рівень - 0, середній - 1, достатній - 2, високий - 3. 
 Одна заявка може отримати максимально 30 балів. 
 Мінімальна кількість балів конкурсної заявки, що дає можливість - 15 балів.
 За результатами оцінювання конкурсних пропозицій організатор конкурсу формує рейтинг конкурсних заявок, який затверджує конкурсна комісія. Рейтинг та результати оцінювання конкурсних пропозицій підлягають обов'язковому оприлюдненню на сайті організатора конкурсу, наступного дня після їх затвердження.  
